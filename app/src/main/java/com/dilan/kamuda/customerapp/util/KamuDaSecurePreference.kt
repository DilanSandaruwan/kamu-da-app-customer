...
import com.dilan.kamuda.customerapp.mysecret.food_house_mobile
...
class KamuDaSecurePreference {
    ...
    fun getFoodHouseHotline(context: Context): String {
        val sharedPreferences = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE)
        return sharedPreferences.getString(FOOD_HOUSE_HOTLINE_KEY, food_house_mobile) ?: food_house_mobile
    }
